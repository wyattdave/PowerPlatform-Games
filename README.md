# PowerPlatform-Games
Microsoft Power Platform may not be built for games but that doesn't mean it cant. So this Repo of all about sharing creative games developers have created on Power Apps, Power Pages, Power BI, Power Automate and Copilot Studio.

## How to Share
Anyone can submit a game to this repo, it just requires the following:

- To be in an unmanaged Solution
...
- Clone this repo
- Create a folder for your game in the relevant technology
- Upload your solution
- Upload any dependency files (e.g Excel table, Office Script File, Custom Connector solution)
- Copy README_Template.md file to your folder
...
If you are not confident on GitHub you can also email [PowerPlatform-Games@powerdevbox.com](PowerPlatform-Games@powerdevbox.com), attaching your solution. We will then email you back with required information.
...
## Liability
This Repo and the maintainers are not liable for any impacts caused by solutions on this repo.
